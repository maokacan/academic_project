...
START_TEST(sprintf_1_string) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, val), custom_sprintf(str2, str3, val));
...
START_TEST(sprintf_2_string) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, val, val2, val3),
                   custom_sprintf(str2, str3, val, val2, val3));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_6_string) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, val, val2, val3, val4),
                   custom_sprintf(str2, str3, val, val2, val3, val4));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_8_string) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, val, val2, val3, val4, val5),
                   custom_sprintf(str2, str3, val, val2, val3, val4, val5));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_10_string) {
  ...
  ck_assert_int_eq(
      ...
      custom_sprintf(str2, str3, val, val, val, val, val, val, val, val, val));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_16_string) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, val, val2, val4, val3),
                   custom_sprintf(str2, str3, val, val2, val4, val3));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_17_string) {
  ...
  char *val = NULL;
  custom_sprintf(str2, str3, val, val, val, val, val, val, val, val, val, val, val,
              val);
