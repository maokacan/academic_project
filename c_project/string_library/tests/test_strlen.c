...
START_TEST(strlen_1) {
  ...
  ck_assert_int_eq(strlen(str), custom_strlen(str));
}
END_TEST
...
START_TEST(strlen_15) {
  ...
  ck_assert_msg(custom_strlen(str_1) == strlen(str_1), "1st strlen test failed");

  char *str_2 = "";
  ck_assert_msg(custom_strlen(str_2) == strlen(str_2), "2nd strlen test failed");

  char *str_3 = "amogus";
  ck_assert_msg(custom_strlen(str_3) == strlen(str_3), "3rd strlen test failed");

  char *str_4 = "shrek";
  ck_assert_msg(custom_strlen(str_4) == strlen(str_4), "4rth strlen test failed");

  char *str_5 = "is love";
  ck_assert_msg(custom_strlen(str_5) == strlen(str_5), "5th strlen test failed");
}
END_TEST
