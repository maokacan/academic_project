...
START_TEST(sprintf_1_f) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, num, num, num, num, num),
                   custom_sprintf(str2, str3, num, num, num, num, num));
...
START_TEST(sprintf_3_f) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, num_long, num_long),
                   custom_sprintf(str2, str3, num_long, num_long));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_4_f) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, num, num, num),
                   custom_sprintf(str2, str3, num, num, num));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_7_f) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, num, num),
                   custom_sprintf(str2, str3, num, num));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_54_f) {
  ...
  double num = 0.235300;
  ck_assert_int_eq(sprintf(str1, str3, num), custom_sprintf(str2, str3, num));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
